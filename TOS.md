...
This Terms of Service Agreement (the "Agreement") is entered into between [AncientAnarchist] ("Bot Owner") and the user ("User") of the [Punch Bot] Discord bot (the "Bot").
